...
def get_sensor_info():
    return make_valid_request(method="get_info")


def get_sensor_reading():
    return make_valid_request(method="get_reading")
...
def test_sanity():
    ...
    assert isinstance(sensor_firmware_version, int), "Sensor firmware version is not a string"
